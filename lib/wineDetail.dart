            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text('375ml of Accento Sospiro',
                      style: TextStyle(fontSize: 12.0, color: Colors.grey)),
                  Text(
                      'Accento by Sospiro perfume is a Amber Woody fagrance for women and men',
                      style: TextStyle(fontSize: 12.0, color: Colors.grey))
                ],
              ),
            ),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  child: Text(
                      'Accento was launched in 2011. Accento was created by Christian Carbonnel and Laura Santander.Top notes are Pineapple and Hyacinth; middle notes are Pink Pepper , iris and Jasmine ; base notes are Musk , Amber, Vetiver, Patchouli and Vanille.',
                      style: TextStyle(fontSize: 12.0, color: Colors.grey)),
                ),
              ],
            ),
